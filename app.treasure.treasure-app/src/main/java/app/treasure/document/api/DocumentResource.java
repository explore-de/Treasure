package app.treasure.document.api;

import app.treasure.bommel.domain.Bommel;
import app.treasure.bommel.repository.BommelRepository;
import app.treasure.document.domain.AnalysisStatus;
import app.treasure.document.domain.Document;
import app.treasure.document.domain.DocumentStatus;
import app.treasure.document.domain.DocumentTag;
import app.treasure.document.domain.TagSource;
import app.treasure.document.domain.TradeParty;
import app.treasure.document.repository.DocumentRepository;
import app.treasure.document.service.DocumentAnalysisService;
import app.treasure.document.service.DocumentDataService;
import app.treasure.document.service.DocumentFileService;
import app.treasure.organization.domain.Organization;
import app.treasure.shared.security.OrganizationContext;
import app.treasure.shared.util.FlashKeys;
import app.treasure.transaction.domain.TransactionRecord;
import app.treasure.transaction.repository.TransactionRecordRepository;
...
public class DocumentResource extends Controller
{
	...
	@Inject
	app.treasure.document.temporal.TemporalDocumentService temporalService;
		...
		@RestForm String tags)
	{
		...
		app.treasure.document.temporal.ReviewInput reviewInput = new app.treasure.document.temporal.ReviewInput(
	...
	public void createTransactionFromDocument(Long id)
	{
		...
		{
			app.treasure.transaction.domain.TagSource source = docTag.getSource() == TagSource.AI
				? app.treasure.transaction.domain.TagSource.AI
				: app.treasure.transaction.domain.TagSource.MANUAL;
		...
		redirect(app.treasure.transaction.api.TransactionResource.class).show(transaction.getId());
	}
}
