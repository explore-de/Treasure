...
This service extracts embedded ZugFerd XML invoice data from PDF documents using the Mustang Project library. It provides a REST API for ZugFerd extraction and integrates with the main Treasure application.
...
Create a `.env` file in the `app.treasure.zugferd` directory with the following variables:
